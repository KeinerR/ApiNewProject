...
namespace API_OPTIMUS.Controllers
{
    ...
    public class ComprasController : ControllerBase
    {
        ...
        public ComprasController(OptimusContext context, ProductosController disparador)
        {
            _context = context;
                    ...
                    if (detalleCompra.Lotes != null)
                    {
                        foreach (var lote in detalleCompra.Lotes)
                        {
                            var newLote = new Lote
                            {
                                ...
                                UnidadId = lote.UnidadId,
                                CantidadCompraPorUnidad = lote.CantidadCompraPorUnidad,
        ...
        [HttpGet("GetLotesPorCompraId")]
        public async Task<List<Lote>> GetLotesPorCompraId(int compraId)
        {
